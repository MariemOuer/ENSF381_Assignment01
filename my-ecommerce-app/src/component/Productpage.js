...
import './styles.css'; // Ensure this path is correct in your project

// Import images
import airJordanMensGolfShoes from './data/images/air-jordan--mens-golf-shoes-ZgQdl6.png';
import airJordan6RetroYellowMensShoes from './data/images/air-jordan-6-retro-yellow-mens-shoes.png';
import airJordan1ElementMwnShoes from './data/images/air-jordan-1-element-mwn-shoes.png';
import airJordan1LowSeMensShoes from './data/images/air-jordan-1-low-se-mens-shoes.png';
import jumpmanMvpWomensShoes from './data/images/jumpman-mvp-womens-shoes-v92HlS.png';
import airJordan3RetroCraftIvoryWomensShoes from './data/images/air-jordan-3-retro-craft-ivory-womens-shoes.png';
import airJordan1LowWomensShoes from './data/images/air-jordan-1-low-womens-shoes.png';
import airJordan1HighOgSatinBredWomensShoes from './data/images/air-jordan-1-high-og-satin-bred-womens-shoes.png';
  ...
  addToCart = (product) => {
    ...
    this.setState(prevState => {
        ...
        if (existingProductIndex >= 0) {
            // Product already in cart, so increase its quantity
